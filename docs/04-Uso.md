...
¡Felicidades! Ya tienes **Fuente_dos** instalada en tu computadora. Ahora es momento de utilizarla en tus documentos.
...
3. Haz clic en la flecha para desplegar la lista y busca **`Fuente_dos`**. *(Puedes escribir "Zoofi" directamente en la caja para encontrarla más rápido).*
